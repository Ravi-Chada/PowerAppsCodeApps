...
export const VERB_HELP_REGISTRY = {
    ...
    login: { description: HelpStrings.Verbs.Login.Description },
    logout: { description: HelpStrings.Verbs.Logout.Description },
    'auth-status': { description: HelpStrings.Verbs['Auth-status'].Description },
    'auth-switch': { description: HelpStrings.Verbs['Auth-switch'].Description },
