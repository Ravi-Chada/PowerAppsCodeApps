 ...
 */
import type { IHttpRequestConfig, IOperationContext, IRuntimeDataClient } from '../common/types';
...
export declare class RuntimeDataClient implements IRuntimeDataClient {
    ...
    private readonly _createRequestBody?;
    private static readonly SERVICES;
    private static readonly ACTIONS;
    private static readonly REQUEST_SOURCE;
    constructor(_powerOperationExecutor: IPowerOperationExecutor, _createRequestBody?: (config: IHttpRequestConfig) => Blob | string | Uint8Array | ArrayBuffer);
    /**
     * Creates a new instance of RuntimeDataClient
     */
    static createInstanceAsync(powerOperationExecutor: IPowerOperationExecutor, createRequestBody?: (config: IHttpRequestConfig) => Blob | string | Uint8Array | ArrayBuffer): Promise<IRuntimeDataClient>;
    /**
